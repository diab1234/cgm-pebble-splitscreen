...
function fetchCgmData(lastReadTime, lastBG) {
    ...
    req.open('GET', https://klsdiabetesadam.azurewebsites.net, true); //edit name below in message
    var req2 = new XMLHttpRequest();
    req2.open('GET', https://klsdiabetesad.azurewebsites.net, true); // edit name below in message 
            ...
            if (req.status == 200) {
                ...
                req2.onload = function(o) {
                    ...
                    var message = {
                        ...
                        delta2: battery2 + Share + response2.bgs[0].bgdelta
